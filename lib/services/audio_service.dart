...
class AudioService {
  ...
  void playJump()   { if (_enabled && _jumpSource   != null) SoLoud.instance.play(_jumpSource!,   volume: 0.15); }
  void playScore()  { if (_enabled && _scoreSource  != null) SoLoud.instance.play(_scoreSource!,  volume: 0.22); }
  void playHit()    { if (_enabled && _hitSource    != null) SoLoud.instance.play(_hitSource!,    volume: 0.25); }
  void playButton() { if (_enabled && _buttonSource != null) SoLoud.instance.play(_buttonSource!, volume: 0.22); }
