  ...
  static const List<GameCharacter> all = [
    ...
    GameCharacter(
      ...
      biomeColors: BiomeColors(
        ...
        skyBottom: Color(0xFF2D2D5F),
        skyAccent: Color(0xFF4A3A7A),
        treeTrunk: Color(0xFF3D2D5C),
        treeEmber: Color(0xFFB388FF),
        groundColor: Color(0xFF2A2A42),
        groundDark: Color(0xFF1A1A2E),
